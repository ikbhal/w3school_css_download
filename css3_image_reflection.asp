<!DOCTYPE html>
<!-- saved from url=(0055)https://www.w3schools.com/css/css3_image_reflection.asp -->
...
<link rel="stylesheet" href="./css3_image_reflection_files/w3schools30.css">

<!-- Google Tag Manager -->
<script async="" src="./css3_image_reflection_files/gtm.js.download"></script><script>
...
<script src="./css3_image_reflection_files/uic.js.download"></script>
...
<script async="" data-cfasync="false" src="./css3_image_reflection_files/loader.js.download" type="text/javascript"></script>
<script src="./css3_image_reflection_files/my-learning.js.download"></script>
...
<link rel="stylesheet" type="text/css" href="./css3_image_reflection_files/browserref.css">
<style>
#reflectimg {
...
<a target="_top" href="https://www.w3schools.com/css/css3_image_reflection.asp" class="active">CSS Image Reflection</a>
...
<h1>CSS <span class="color_h1">Image Reflection</span></h1>

<hr>
<p>In this chapter you will learn how to reflect an image.</p>
<img id="reflectimg" src="./css3_image_reflection_files/img_tree.png">
<hr>

<h2>CSS Image Reflections</h2>
<p>The <code class="w3-codespan">box-reflect</code> property is used to create an image reflection.</p>
<p>The value of the <code class="w3-codespan">box-reflect</code> property 
can be: <code class="w3-codespan">below</code>, <code class="w3-codespan">above</code>,
<code class="w3-codespan">left</code> , or <code class="w3-codespan">right</code>.</p>
<hr>
<h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully supports the property.</p>
<p>Numbers followed by -webkit- specify the first version that worked with a 
prefix.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Here we want the reflection below the image:</p>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
   img <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; -webkit-box-reflect<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> below<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span>  </span></div>

</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Here we want the reflection to the right of the image:</p>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
   img <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; -webkit-box-reflect<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> right<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span>  </span></div>

</div>
<hr>

<h2>CSS Reflection Offset</h2>
<p>To specify the gap between the image and the reflection, add the size of the 
gap to the <code class="w3-codespan">box-reflect</code> property.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Here we want the reflection below the image, with a 20px offset:</p>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
   img <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; -webkit-box-reflect<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> below 20px<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span>  </span></div>

</div>
<hr>

<h2>CSS Reflection With Gradient</h2>
<p>We can also create a fade-out effect on the reflection.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Create a fade-out effect on the reflection:</p>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
   img <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; -webkit-box-reflect<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> below 0px linear-gradient(to bottom, rgba(0,0,0,0.0), 
   rgba(0,0,0,0.4))<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span>  </span></div>
...
<script src="./css3_image_reflection_files/w3schools_footer.js.download"></script>
