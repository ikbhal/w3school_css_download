<!DOCTYPE html>
<!-- saved from url=(0054)https://www.w3schools.com/css/css3_object-position.asp -->
...
<link rel="stylesheet" href="./css3_object-position_files/w3schools30.css">

<!-- Google Tag Manager -->
<script async="" src="./css3_object-position_files/gtm.js.download"></script><script>
...
<script src="./css3_object-position_files/uic.js.download"></script>
...
<script async="" data-cfasync="false" src="./css3_object-position_files/loader.js.download" type="text/javascript"></script>
<script src="./css3_object-position_files/my-learning.js.download"></script>
...
<link rel="stylesheet" type="text/css" href="./css3_object-position_files/browserref.css">
</head>
...
<a target="_top" href="https://www.w3schools.com/css/css3_object-position.asp" class="active">CSS object-position</a>
...
<h1>CSS <span class="color_h1">The object-position Property</span></h1>

<hr>
<p class="intro">The CSS <code class="w3-codespan">object-position</code> property 
...
<img src="./css3_object-position_files/paris.jpg" alt="Paris" style="width:400px;height:300px">
<p>Next, we use <code class="w3-codespan">object-fit: cover;</code> to keep the 
aspect ratio and to fill the given dimension. However, the image will be clipped to fit, 
like this:</p>
<img src="./css3_object-position_files/paris.jpg" alt="Paris" style="width:200px;height:300px;object-fit:cover;">
...
<h2>Using the object-position Property</h2>
<p>Let's say that the part of the image that is shown, is not positioned as we want. To 
position the image, we will use the <code class="w3-codespan">object-position</code> property.</p>
<p>Here we will use the <code class="w3-codespan">object-position</code> property 
to position the image so that the great old building is in 
center:</p>

<img src="./css3_object-position_files/paris.jpg" alt="Paris" style="width:200px;height:300px;object-fit:cover;object-position:80% 100%">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
img <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; width<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 200px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp;&nbsp;height<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 
  300px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp;&nbsp;object-fit<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> cover<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; object-position<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 80% 100%<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span> </span></div>
...
<img src="./css3_object-position_files/paris.jpg" alt="Paris" style="width:200px;height:300px;object-fit:cover;object-position:15% 100%">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
img <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; width<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 200px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp;&nbsp;height<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 
  300px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp;&nbsp;object-fit<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> cover<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; object-position<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 15% 100%<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span> </span></div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><a href="https://www.w3schools.com/cssref/css3_pr_object-position.asp">object-posititon</a></td>
...
<script src="./css3_object-position_files/w3schools_footer.js.download"></script>
