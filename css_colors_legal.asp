<!DOCTYPE html>
<!-- saved from url=(0053)https://www.w3schools.com/cssref/css_colors_legal.asp -->
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>CSS Legal Color Values</title>
...
<link rel="stylesheet" href="./css_colors_legal_files/w3schools30.css">

<!-- Google Tag Manager -->
<script async="" src="./css_colors_legal_files/gtm.js.download"></script><script>
...
<script src="./css_colors_legal_files/uic.js.download"></script>
...
<script async="" data-cfasync="false" src="./css_colors_legal_files/loader.js.download" type="text/javascript"></script>
<script src="./css_colors_legal_files/my-learning.js.download"></script>
...
<a target="_top" href="https://www.w3schools.com/cssref/css_colors_legal.asp" class="active">CSS Color Values</a>
...
<h1>CSS <span class="color_h1">Legal Color Values</span></h1>
...
<ul>
  ...
  <li>With the <code class="w3-codespan">currentcolor</code> keyword</li>
</ul>
<hr>

<h2>Hexadecimal Colors</h2>
<p>A hexadecimal color is specified with: #RRGGBB, where the RR (red), GG (green) and BB (blue) hexadecimal integers specify the components of the color. 
All values must be between 00 and FF.</p>
<p>For example, the #0000ff value is rendered as blue, because the blue component is set to its highest value (ff) and the others are set to 
00.</p>

<div class="w3-example">
<h3>Example</h3>
 <p>Define different HEX colors:</p>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
 #p1 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> #ff0000<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* red */</span><br>#p2 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> #00ff00<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* green */</span><br>#p3 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> #0000ff<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* blue */</span>
 </span></div>

</div>
<hr>

<h2>Hexadecimal Colors With Transparency</h2>
<p>A hexadecimal color is specified with: #RRGGBB. To add transparency, add two 
additional digits between 00 and FF.</p>

<div class="w3-example">
<h3>Example</h3>
 <p>Define different HEX colors with transparency:</p>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
 #p1a <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> #ff000080<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* red transparency */</span><br>#p2a <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> #00ff0080<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* green 
  transparency */</span><br>#p3a <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> #0000ff80<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* blue 
  transparency */</span>
 </span></div>
...
<h2>RGB Colors</h2>
<p>An RGB color value is specified with the <a href="https://www.w3schools.com/cssref/func_rgb.asp">rgb() function</a>, which has the following syntax:</p>
<p><code class="w3-codespan">rgb(red, green, blue)</code></p>
<p>Each parameter (red, green, and 
blue) defines the intensity of the color and can be an integer between 0 and 255 or a percentage value (from 0% to 100%).</p>
<p>For example, the rgb(0,0,255) value is rendered as blue, 
because the blue parameter is set to its highest value (255) and the others are 
set to 0.</p>
<p>Also, the following values define equal color: rgb(0,0,255) and rgb(0%,0%,100%).</p>

<div class="w3-example">
<h3>Example</h3>
 <p>Define different RGB colors:</p>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
 #p1 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> rgb(255, 0, 0)<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* red */</span><br>#p2 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> rgb(0, 255, 0)<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* green */</span><br>#p3 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> rgb(0, 0, 255)<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* blue */</span>
 </span></div>
...
<h2>RGBA Colors</h2>
<p>RGBA color values are an extension of RGB color values with an alpha channel - which specifies the opacity of the object.</p>
<p>An RGBA color is specified with the <a href="https://www.w3schools.com/cssref/func_rgba.asp">rgba() function</a>, which has the following syntax:</p>
<p><code class="w3-codespan">rgba(red, green, blue, alpha)</code></p>
<p>The alpha parameter is a number between 0.0 (fully transparent) and 1.0 (fully opaque).</p>

<div class="w3-example">
<h3>Example</h3>
 <p>Define different RGB colors with opacity:</p>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
 #p1 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> rgba(255, 0, 0, 0.3)<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* red with opacity */</span><br>#p2 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> rgba(0, 255, 0, 0.3)<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* green with opacity */</span><br>#p3 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> rgba(0, 0, 255, 0.3)<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* blue with opacity */</span>
 </span></div>
...
<p>An HSL color value is specified with the <a href="https://www.w3schools.com/cssref/func_hsl.asp">hsl() 
function</a>, which has the following syntax:</p>
<p><code class="w3-codespan">hsl(hue, saturation, lightness)</code></p>
<p>Hue is a degree on the color wheel (from 0 to 360) - 0 (or 360) is red, 120 
...
<div class="w3-example">
<h3>Example</h3>
 <p>Define different HSL colors:</p>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
 #p1 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> hsl(120, 100%, 50%)<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* green */</span><br>#p2 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> hsl(120, 100%, 75%)<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* light green */</span><br>#p3 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> hsl(120, 100%, 25%)<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* dark green */</span><br>#p4 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> hsl(120, 60%, 70%)<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* pastel green */</span>
 </span></div>
...
<h2>HSLA Colors</h2>
<p>HSLA color values are an extension of HSL color values with an alpha channel - which specifies the opacity of the object.</p>
<p>An HSLA color value is specified with the <a href="https://www.w3schools.com/cssref/func_hsla.asp">hsla() 
function</a>, which has the following syntax:</p>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Define different HSL colors with opacity:</p>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
 #p1 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> hsla(120, 100%, 50%, 0.3)<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* green with opacity */</span><br>#p2 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> hsla(120, 100%, 75%, 0.3)<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* light green with opacity */</span><br>#p3 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> hsla(120, 100%, 25%, 0.3)<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* dark green with opacity */</span><br>#p4 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> hsla(120, 60%, 70%, 0.3)<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span>&nbsp;&nbsp;&nbsp; <span class="commentcolor" style="color:green">/* pastel green with opacity */</span>
 </span></div>

</div>
<hr>

<h2>Predefined/Cross-browser Color Names</h2>
<p>140 color names are predefined in the HTML and CSS color specification.</p>
<p>For example: <code class="w3-codespan">blue</code>, <code class="w3-codespan">red</code>, <code class="w3-codespan">coral</code>, <code class="w3-codespan">brown</code>, etc:</p>
<div class="w3-example">
<h3>Example</h3>
 <p>Define different color names:</p>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
 #p1 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> blue<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span><br>#p2 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> red<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span><br>#p3 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> coral<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span><br>#p4 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">background-color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> brown<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span> </span></div>

</div>
<div class="w3-note w3-panel">
<p>A list of all predefined names can be found in our <a href="https://www.w3schools.com/colors/colors_names.asp">Color Names Reference</a>.</p>
</div>
<hr>

<h2>The currentcolor Keyword</h2>
<p>The <code class="w3-codespan">currentcolor</code> keyword refers to the value of the color property of an element.</p>
...
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
  #myDIV <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> blue<span class="cssdelimitercolor" style="color:black">;</span></span> <span class="commentcolor" style="color:green">/* Blue text color */</span><br>&nbsp; border<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 10px solid currentcolor<span class="cssdelimitercolor" style="color:black">;</span></span> 
  <span class="commentcolor" style="color:green">/* Blue border color */</span><br>
...
<script src="./css_colors_legal_files/w3schools_footer.js.download"></script>
