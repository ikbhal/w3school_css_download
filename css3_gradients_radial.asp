<!DOCTYPE html>
<!-- saved from url=(0055)https://www.w3schools.com/css/css3_gradients_radial.asp -->
...
<link rel="stylesheet" href="./css3_gradients_radial_files/w3schools30.css">

<!-- Google Tag Manager -->
<script async="" src="./css3_gradients_radial_files/gtm.js.download"></script><script>
...
<script src="./css3_gradients_radial_files/uic.js.download"></script>
...
<script async="" data-cfasync="false" src="./css3_gradients_radial_files/loader.js.download" type="text/javascript"></script>
<script src="./css3_gradients_radial_files/my-learning.js.download"></script>
...
<a target="_top" href="https://www.w3schools.com/css/css3_gradients_radial.asp" class="active">Radial Gradients</a>
...
<h1>CSS <span class="color_h1">Radial Gradients</span></h1>
...
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
    #grad <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; background-image<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> radial-gradient(red, yellow, green)<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span>  </span></div>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
    #grad <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; background-image<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> radial-gradient(red 5%, yellow 15%, green 60%)<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span>  </span></div>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
    #grad <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; background-image<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> radial-gradient(circle, red, yellow, green)<span class="cssdelimitercolor" style="color:black">;</span></span><br>
...
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
    #grad1 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; background-image<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> radial-gradient(closest-side at 60% 55%, red, yellow, 
black)<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span><br>
<br>#grad2 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>
    &nbsp; background-image<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> radial-gradient(farthest-side at 60% 
55%, red, yellow, black)<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span>  </span></div>
...
repeating-radial-gradient(red, yellow 10%, green 15%)<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span>  </span></div>
...
<script src="./css3_gradients_radial_files/w3schools_footer.js.download"></script>
