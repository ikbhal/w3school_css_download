<!DOCTYPE html>
<!-- saved from url=(0049)https://www.w3schools.com/sass/sass_variables.php -->
...
<link rel="stylesheet" href="./sass_variables_files/w3schools30.css">
<!-- Google Tag Manager -->
<script async="" src="./sass_variables_files/gtm.js.download"></script><script>
...
<script src="./sass_variables_files/uic.js.download"></script>
...
<script async="" data-cfasync="false" src="./sass_variables_files/loader.js.download" type="text/javascript"></script>
<script src="./sass_variables_files/my-learning.js.download"></script>
...
body.darkpagetheme .topnavmain_pro {
  ...
  <a class="w3-bar-item w3-button w3-hide-medium bar-item-hover w3-hide-small w3-padding-24 barex" href="https://www.w3schools.com/videos/index.php" title="Video Tutorials">Videos</a>
  ...
  <div class="w3-right w3-padding-16">
    ...
    <a class="w3-bar-item w3-button bar-item-hover w3-right w3-hide-small barex" style="width: 120px; border-radius: 25px; margin-right: 15px;" href="https://www.w3schools.com/spaces" target="_blank" title="Get Your Own Website With W3Schools Spaces">Website</a>
    <a class="w3-bar-item w3-button bar-item-hover w3-right ws-hide-900 w3-hide-small barex ws-pink" style="border-radius: 25px; margin-right: 15px;" href="https://shop.w3schools.com/collections/course-catalog" target="_blank" id="cert_navbtn" title="Courses">Get Certified</a>
    <a class="w3-bar-item w3-button bar-item-hover w3-right ws-hide-900 w3-hide-small ws-hide-1066 barex topnavmain_pro" style="border-radius: 25px; margin-right: 15px;" href="https://www.w3schools.com/pro/index.php" target="_blank" title="Go pro and unlock powerful features">Pro <span class="ribbon-topnav ws-hide-1160">NEW</span></a>    
  </div>  
</div>
...
<div class="w3-card-2 topnav notranslate" id="topnav" style="position: relative;">
...
<!--      <a href='javascript:void(0);' class='topnav-icons fa w3-right w3-bar-item w3-button' onclick='changecodetheme(this)' title='Toggle Dark Code Examples'>&#xe80b;</a>-->
      <a href="javascript:void(0);" class="topnav-icons fa w3-right w3-bar-item w3-button" onmouseover="mouseoverdarkicon()" onmouseout="mouseoutofdarkicon()" onclick="changepagetheme(2)" xtitle="Toggle Dark Code Examples"></a>
...
<a target="_top" href="https://www.w3schools.com/sass/sass_variables.php" class="active">Sass Variables</a>
  ...
  <div class="w3-row w3-white">
    <div class="w3-col l10 m12" id="main">
      <div id="mainLeaderboard" style="overflow:hidden;">
        ...
        <!-- adspace leaderboard -->
      </div><h1>Sass <span class="color_h1">Variables</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="https://www.w3schools.com/sass/sass_installation.php">❮ Previous</a>
  <a class="w3-right w3-btn" href="https://www.w3schools.com/sass/sass_nesting.php">Next ❯</a>
</div>
<hr>
<h2>Sass Variables</h2>
<p>Variables are a way to store information that you can re-use later.</p>
<p>With Sass, you can store information in variables, like:</p>
<ul>
  <li>strings</li>
  <li>numbers</li>
  <li>colors</li>
...
<p>Sass uses the $ symbol, followed by a name, to declare variables:</p>
<div class="w3-example">
<p>Sass Variable Syntax:</p>
<div class="w3-code notranslate xcssHigh">
$<i>variablename</i>: <em>value</em>;
</div>
</div>

<p>The following example declares 4 variables named myFont, myColor, myFontSize, and myWidth.
...
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
  ...
  $myWidth: 680px;<br><br>body <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>
  &nbsp;
  font-family<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> $myFont<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp;
  font-size<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> $myFontSize<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> $myColor<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span><br><br>#container <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; 
  width<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> $myWidth<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span>
 </span></div>
<p>
<a target="_blank" class="w3-btn" href="https://www.w3schools.com/sass/showsass.php?filename=demo_sass_var1">Run Example »</a>
</p>
</div>

<p>So, when the Sass file is transpiled, it takes the variables (myFont, myColor, 
...
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
  ...
  font-size<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 18px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> red<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span><br><br>#container <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; 
  width<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 680px<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span>
 </span></div>
<br>
</div>
<hr>
...
<h2>Sass Variable Scope</h2>
<p>Sass variables are only available at the level of nesting where they are defined.</p>
<p>Look at the following example:</p>
<div class="w3-example">
<p>SCSS Syntax:</p>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
  $myColor: red;<br><br>h1 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>
  &nbsp;
  $myColor<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> green<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> $myColor<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span><br><br>p <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; 
  color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> $myColor<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span>
 </span></div>
<p>
<a target="_blank" class="w3-btn" href="https://www.w3schools.com/sass/showsass.php?filename=demo_sass_var2">Run Example »</a>
</p>
</div>

<p>Will the color of the text inside a <code class="w3-codespan">&lt;p&gt;</code> tag be red or green? It will be red!</p>
<p>The other definition, $myColor: green; is inside the 
<code class="w3-codespan">&lt;h1&gt;</code> rule, and will only 
be available there!</p>
<p>So, the CSS output will be:</p>

<div class="w3-example">
  <p>CSS Output:</p>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
  h1 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>
  &nbsp; color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> green<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span><br><br>p <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; 
  color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> red<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span>
 </span></div>
<br>
</div>

<p>Ok, that is the default behavior for variable scope.</p>

<hr>
<h2>Using Sass !global</h2>
<p>The default behavior for variable scope can be overridden by using the 
<code class="w3-codespan">!global</code> switch.</p>
<p> 
<code class="w3-codespan">!global</code> indicates that a variable is global, 
which means that it is accessible on all levels.</p>
<p>Look at the following example (same as above; but with 
<code class="w3-codespan">!global</code> added):</p>
<div class="w3-example">
<p>SCSS Syntax:</p>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
  $myColor: red;<br><br>h1 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>
  &nbsp;
  $myColor<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> green !global<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> $myColor<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span><br><br>p <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; 
  color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> $myColor<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span>
 </span></div>
<p>
<a target="_blank" class="w3-btn" href="https://www.w3schools.com/sass/showsass.php?filename=demo_sass_var3">Run Example »</a>
</p>
</div>

<p>Now the color of the text inside a <code class="w3-codespan">&lt;p&gt;</code> tag will be green!</p>
<p>So, the CSS output will be:</p>
...
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
  h1 <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>
  &nbsp; color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> green<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span><br><br>p <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; 
  color<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> green<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span> </span></div>
<br>
</div>

<div class="w3-panel w3-note">
<p><strong>Tip:</strong> Global variables should be defined outside any rules. It could be 
wise to define all global variables in its own file, named "_globals.scss", and 
include the file with the <a href="https://www.w3schools.com/sass/sass_mixin_include.php">@include</a> keyword.</p>
</div>
...
<div class="sidesection" id="video_sidesection">
  ...
  <a href="https://www.w3schools.com/videos/index.php" class="w3-hover-opacity"><img src="./sass_variables_files/htmlvideoad_footer.png" style="max-width:100%;padding:5px 10px 25px 10px" loading="lazy"></a>
...
<img src="./sass_variables_files/colorpicker2000.png" alt="colorpicker" loading="lazy">
</a>
</div>
...
<a class="w3-btn" id="courses_get_started_btn" href="https://shop.w3schools.com/collections/course-catalog" target="_blank">Get started</a>
</div>
<script>
...
.codegameright .w3-btn:hover,.codegameright .w3-btn:active {
  ...
  <a href="https://www.w3schools.com/codegame/index.html" target="_blank" class="w3-hover-opacity"><img style="max-width:100%;margin:16px 0;" src="./sass_variables_files/w3lynx_200.png" alt="Code Game" loading="lazy"></a>
...
<a href="https://shop.w3schools.com/collections/course-catalog/products/html-course" target="_blank">HTML Course</a><br>
<a href="https://shop.w3schools.com/collections/course-catalog/products/css-course" target="_blank">CSS Course</a><br>
<a href="https://shop.w3schools.com/collections/course-catalog/products/javascript-course" target="_blank">JavaScript Course</a><br>
<a href="https://shop.w3schools.com/collections/course-catalog/products/front-end-course" target="_blank">Front End Course</a><br>
<a href="https://shop.w3schools.com/collections/course-catalog/products/sql-course" target="_blank">SQL Course</a><br>
<a href="https://shop.w3schools.com/collections/course-catalog/products/python-course" target="_blank">Python Course</a><br>
<a href="https://shop.w3schools.com/collections/course-catalog/products/php-course" target="_blank">PHP Course</a><br>
<a href="https://shop.w3schools.com/collections/course-catalog/products/jquery-course" target="_blank">jQuery Course</a><br>
<a href="https://shop.w3schools.com/collections/course-catalog/products/java-course" target="_blank">Java Course</a><br>
<a href="https://shop.w3schools.com/collections/course-catalog/products/c-course-1" target="_blank">C++ Course</a><br>
<a href="https://shop.w3schools.com/collections/course-catalog/products/c-course" target="_blank">C# Course</a><br>
<a href="https://shop.w3schools.com/collections/course-catalog/products/xml-course" target="_blank">XML Course</a><br>
<a href="https://shop.w3schools.com/collections/course-catalog" target="_blank" class="w3-button w3-margin-top ws-black ws-hover-black w3-round" style="text-decoration:none">
Get Certified »</a>
...
<a href="https://www.w3schools.com/w3css/default.asp">W3Schools is Powered by W3.CSS</a>.<br><br>
</div>
...
<script src="./sass_variables_files/w3schools_footer.js.download"></script>
