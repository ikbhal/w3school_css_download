<!DOCTYPE html>
<!-- saved from url=(0049)https://www.w3schools.com/css/css3_object-fit.asp -->
...
<link rel="stylesheet" href="./css3_object-fit_files/w3schools30.css">

<!-- Google Tag Manager -->
<script async="" src="./css3_object-fit_files/gtm.js.download"></script><script>
...
<script src="./css3_object-fit_files/uic.js.download"></script>
...
<script async="" data-cfasync="false" src="./css3_object-fit_files/loader.js.download" type="text/javascript"></script>
<script src="./css3_object-fit_files/my-learning.js.download"></script>
...
<link rel="stylesheet" type="text/css" href="./css3_object-fit_files/browserref.css">
</head>
...
<a target="_top" href="https://www.w3schools.com/css/css3_object-fit.asp" class="active">CSS object-fit</a>
...
possible".</p>
<p>Look at the following image from Paris. This image is 400 pixels wide and 300 pixels high:</p>
<img src="./css3_object-fit_files/paris.jpg" alt="Paris" style="width:400px;height:300px">
<p>However, if we style the image above to be half its width (200 pixels) and 
same height (300 pixels), it will look like this:</p>
<img src="./css3_object-fit_files/paris.jpg" alt="Paris" style="width:200px;height:300px">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
img <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp;&nbsp;width<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 200px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp;&nbsp;height<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 
  300px<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span> </span></div>

</div>
<p>We see that the image is being squished to fit the container of 200x300 pixels 
(its original aspect ratio is destroyed).</p>
<p>Here is where the <code class="w3-codespan">object-fit</code> property comes 
in. The <code class="w3-codespan">object-fit</code> property can take one of the 
following values:</p>
<ul>
  <li><code class="w3-codespan">fill</code> - This is default. The image is resized to fill the 
  given dimension. If necessary, the image will be stretched or squished to fit</li>
  <li><code class="w3-codespan">contain</code> - The image 
keeps its aspect ratio, but is resized to fit within the given dimension</li>
  <li><code class="w3-codespan">cover</code> - The image keeps its aspect ratio 
  and fills the given dimension. The image will be clipped to fit</li>
  <li><code class="w3-codespan">none</code> - The image is not resized</li>
  <li><code class="w3-codespan">scale-down</code> - the image is 
  scaled down to the smallest version of <code class="w3-codespan">none</code> or <code class="w3-codespan">
contain</code></li>
</ul>
<hr>

<h2>Using object-fit: cover;</h2>
<p>If we use <code class="w3-codespan">object-fit: cover;</code> the image keeps its aspect ratio 
and fills the given dimension. The image will be clipped to fit:</p>
<img src="./css3_object-fit_files/paris.jpg" alt="Paris" style="width:200px;height:300px;object-fit:cover;">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
img <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; width<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 200px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; height<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 
  300px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; object-fit<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> cover<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span> </span></div>
...
<p>If we use <code class="w3-codespan">object-fit: contain;</code> the image 
keeps its aspect ratio, but is resized to fit within the given dimension:</p>
<img src="./css3_object-fit_files/paris.jpg" alt="Paris" style="width:200px;height:300px;object-fit:contain;">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
img <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; width<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 200px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; height<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 
  300px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; object-fit<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> contain<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span> </span></div>

</div>
<hr>

<h2>Using object-fit: fill; </h2>
<p>If we use <code class="w3-codespan">object-fit: fill;</code> the image is 
resized to fill the given dimension. If necessary, the image will be 
stretched or squished to fit:</p>
<img src="./css3_object-fit_files/paris.jpg" alt="Paris" style="width:200px;height:300px;object-fit:fill;">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
img <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; width<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 200px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; height<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 
  300px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; object-fit<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> fill<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span> </span></div>

</div>
<hr>

<h2>Using object-fit: none; </h2>
<p>If we use <code class="w3-codespan">object-fit: none;</code> the image is not 
resized:</p>
<img src="./css3_object-fit_files/paris.jpg" alt="Paris" style="width:200px;height:300px;object-fit:none;">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
img <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; width<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 200px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; height<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 
  300px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; object-fit<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> none<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span> </span></div>

</div>
<hr>

<h2>Using object-fit: scale-down; </h2>
<p>If we use <code class="w3-codespan">object-fit: scale-down;</code> the image is 
scaled down to the smallest version of <code class="w3-codespan">none</code> or <code class="w3-codespan">
contain</code>:</p>
<img src="./css3_object-fit_files/paris.jpg" alt="Paris" style="width:200px;height:300px;object-fit:scale-down;">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
img <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red"><br>&nbsp; width<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 200px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; height<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> 
  300px<span class="cssdelimitercolor" style="color:black">;</span></span><br>&nbsp; object-fit<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> scale-down<span class="cssdelimitercolor" style="color:black">;</span></span><br></span><span class="cssdelimitercolor" style="color:black">}</span> </span></div>
...
<div style="width:100%;height:300px;">
  <img src="./css3_object-fit_files/rock600x400.jpg" alt="Norway" style="float:left;width:50%;height:100%;">
  <img src="./css3_object-fit_files/paris.jpg" alt="Paris" style="float:left;width:50%;height:100%;">
</div>
<br>
</div>
...
<div>
<div style="width:100%;height:300px;">
  <img src="./css3_object-fit_files/rock600x400.jpg" alt="Norway" style="float:left;width:50%;height:100%;object-fit:cover;">
  <img src="./css3_object-fit_files/paris.jpg" alt="Paris" style="float:left;width:50%;height:100%;object-fit:cover;">
</div>
<br>
</div>
...
<h2>&nbsp;CSS object-fit More Examples</h2>
<p>The following example demonstrates all the possible values of the <code class="w3-codespan">object-fit</code> property 
in one example:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh"><span class="cssselectorcolor" style="color:brown">
.fill <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">object-fit<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> fill<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span><br>
.contain <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">object-fit<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> contain<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span><br>
.cover <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">object-fit<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> cover<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span><br>
.scale-down <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">object-fit<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> scale-down<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span><br>
.none <span class="cssdelimitercolor" style="color:black">{</span><span class="csspropertycolor" style="color:red">object-fit<span class="csspropertyvaluecolor" style="color:mediumblue"><span class="cssdelimitercolor" style="color:black">:</span> none<span class="cssdelimitercolor" style="color:black">;</span></span></span><span class="cssdelimitercolor" style="color:black">}</span> </span></div>

</div>
<hr>

<h2>CSS Object-* Properties</h2>
<p>The following table lists the CSS object-* properties:</p>
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><a href="https://www.w3schools.com/cssref/css3_pr_object-fit.asp">object-fit</a></td>
    <td>Specifies how an &lt;img&gt; or &lt;video&gt; should be resized to fit its container</td>
  </tr>
  <tr>
    <td><a href="https://www.w3schools.com/cssref/css3_pr_object-position.asp">object-position</a></td>
    <td>Specifies how an &lt;img&gt; or &lt;video&gt; should be positioned with x/y 
    coordinates inside its "own content box"</td>
  </tr>
</tbody></table>
...
<script src="./css3_object-fit_files/w3schools_footer.js.download"></script>
