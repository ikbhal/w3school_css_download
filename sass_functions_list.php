<!DOCTYPE html>
<!-- saved from url=(0054)https://www.w3schools.com/sass/sass_functions_list.php -->
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>Sass List Functions</title>
...
<link rel="stylesheet" href="./sass_functions_list_files/w3schools30.css">
<!-- Google Tag Manager -->
<script async="" src="./sass_functions_list_files/gtm.js.download"></script><script>
...
<script src="./sass_functions_list_files/uic.js.download"></script>
...
<script async="" data-cfasync="false" src="./sass_functions_list_files/loader.js.download" type="text/javascript"></script>
<script src="./sass_functions_list_files/my-learning.js.download"></script>
...
<a target="_top" href="https://www.w3schools.com/sass/sass_functions_list.php" class="active">Sass List</a>
  ...
  <div class="w3-row w3-white">
    <div class="w3-col l10 m12" id="main">
      <div id="mainLeaderboard" style="overflow:hidden;">
        ...
        <!-- adspace leaderboard -->
      </div><h1>Sass <span class="color_h1">List Functions</span></h1>

<hr>

<h2>Sass List Functions</h2>
<p>The list functions are used to access values in a list, combine lists, and 
add items to lists.</p>
<p>Sass lists are immutable (they cannot change). So, the list functions that return a 
list, will 
return a new list, and not change the original list.</p>
<p>Sass lists are 1-based. The first list item in a list is at index 1, not 0.</p>
<p>The following table lists all list functions in Sass:</p>
...
<script src="./sass_functions_list_files/w3schools_footer.js.download"></script>
