<!DOCTYPE html>
<!-- saved from url=(0052)https://www.w3schools.com/sass/sass_installation.php -->
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>Sass Installation</title>
...
<link rel="stylesheet" href="./css_grid_item_files/w3schools30.css">
<!-- Google Tag Manager -->
<script async="" src="./css_grid_item_files/gtm.js.download"></script><script>
...
<script src="./css_grid_item_files/uic.js.download"></script>
...
<script async="" data-cfasync="false" src="./css_grid_item_files/loader.js.download" type="text/javascript"></script>
<script src="./css_grid_item_files/my-learning.js.download"></script>
...
<a target="_top" href="https://www.w3schools.com/sass/sass_installation.php" class="active">Sass Installation</a>
  ...
  <div class="w3-row w3-white">
    <div class="w3-col l10 m12" id="main">
      <div id="mainLeaderboard" style="overflow:hidden;">
        ...
        <!-- adspace leaderboard -->
      </div><h1>Sass <span class="color_h1">Installation</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="https://www.w3schools.com/sass/sass_intro.php">❮ Previous</a>
  <a class="w3-right w3-btn" href="https://www.w3schools.com/sass/sass_variables.php">Next ❯</a>
</div>
<hr>
<h2>System Requirements for Sass</h2>
<ul>
  <li><strong>Operating system</strong> - Sass is platform independent</li>
  <li><strong>Browser support</strong> - Sass works in Edge/IE (from IE 8), 
  Firefox, Chrome, Safari, Opera</li>
  <li><strong>Programming language</strong> - Sass is based on Ruby</li>
</ul>
<hr>

<h2>Official Sass Web Site</h2>
<p>Read more about Sass at the official Sass web site:
<a href="https://sass-lang.com/" target="_blank">https://sass-lang.com/</a></p>
<hr>

<h2>Install Sass</h2>
<p>There are several ways to install Sass in your system. There are many 
applications that will get you up and running with Sass in a few minutes for 
Mac, Windows, and Linux. Some of these are free, but some are paid apps.</p>
<p>You can read more about them here:
<a href="https://sass-lang.com/install" target="_blank">sass-lang.com/install</a></p>
...
<div class="sidesection" id="video_sidesection">
  ...
  <a href="https://www.w3schools.com/videos/index.php" class="w3-hover-opacity"><img src="./css_grid_item_files/htmlvideoad_footer.png" style="max-width:100%;padding:5px 10px 25px 10px" loading="lazy"></a>
...
<img src="./css_grid_item_files/colorpicker2000.png" alt="colorpicker" loading="lazy">
</a>
</div>
...
.codegameright .w3-btn:hover,.codegameright .w3-btn:active {
  ...
  <a href="https://www.w3schools.com/codegame/index.html" target="_blank" class="w3-hover-opacity"><img style="max-width:100%;margin:16px 0;" src="./css_grid_item_files/w3lynx_200.png" alt="Code Game" loading="lazy"></a>
...
<script src="./css_grid_item_files/w3schools_footer.js.download"></script>
